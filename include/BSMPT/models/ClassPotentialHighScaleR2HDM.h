...
#ifndef SRC_CLASSPOTENTIALHIGHSCALER2HDM_H_
#define SRC_CLASSPOTENTIALHIGHSCALER2HDM_H_
...
/**
 * @brief The Class_Potential_HighScale_R2HDM class
 * Implementation of the CP-conserving 2HDM with additional light, as given in the manual
 *
 *
 *
 ...
 */
class Class_Potential_HighScale_R2HDM : public Class_Potential_Origin
{
public:
  Class_Potential_HighScale_R2HDM ();
  virtual  ~Class_Potential_HighScale_R2HDM ();
  ...
  double g1ud=0;//Gaugino Gauge Couplings
  double g2ud=0;//Gaugino Gauge Couplings
...
#endif /* SRC_CLASSPOTENTIALHIGHSCALER2HDM_H_ */
